...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url:
        "https://github.com/csukuangfj/piper-phonemize/releases/download/xcframework/piper-phonemize-v1.4.10-macos.xcframework.zip",
      checksum: "7f96aec2316d8f5e04538ca1378d9d4ede7f9b48fe4cc8eba87e5d5868afbc01"
    ),
    .binaryTarget(
      name: "PiperPhonemizeIOS",
      url:
        "https://github.com/csukuangfj/piper-phonemize/releases/download/xcframework/piper-phonemize-v1.4.10-ios.xcframework.zip",
    ...
    .binaryTarget(
      ...
      url:
        "https://github.com/csukuangfj/piper-phonemize/releases/download/xcframework/piper-phonemize-v1.4.10-macos-shared.xcframework.zip",
      checksum: "18d6132841eac41e3efb383b687547baf9d6ba5d45b0927dbd9f546b603043ec"
    ),
    .binaryTarget(
      name: "PiperPhonemizeIOSShared",
      url:
        "https://github.com/csukuangfj/piper-phonemize/releases/download/xcframework/piper-phonemize-v1.4.10-ios-shared.xcframework.zip",
