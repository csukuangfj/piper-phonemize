...
dependencies {
    // 1. JVM core API
    implementation("com.github.csukuangfj.piper-phonemize:piper-phonemize-jvm:v1.4.10")

    // 2. Platform native lib (auto-detected)
    implementation("com.github.csukuangfj.piper-phonemize:piper-phonemize-native-lib-$targetNativeClassifier:v1.4.10")
}
